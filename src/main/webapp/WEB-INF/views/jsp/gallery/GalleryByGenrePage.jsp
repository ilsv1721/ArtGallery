...
<script>
	$(document).ready(function() {
		$("#genreChooser").change(function() {
			$('#paintingArea').fadeOut();
			var selectValue = $(this).val();
			$.ajax({
				type : "GET",
				url : "../rest/paintingsByGenre",
				data : {
					"genreId" : selectValue
				},
...
<div class="w3-card-4">
	<div class="w3-container w3-blue w3-center ilya-smc">
		<p>
			...
			<select class="w3-select w3-border" id="genreChooser">
				<option value="" disabled selected>Choose one of the genres</option>
