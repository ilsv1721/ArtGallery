						...
						$("img")
								.click(
										function() {
											...
											if (r == true) {
												window
														.alert("Well... It is not working yet :<");
											} else {
...
<div class="w3-card-4">
	...
	<sf:form method="POST" modelAttribute="exhibEditionDTO"
		...
		<div class="w3-content w3-display-container">
			<c:forEach items="${exhibEditionDTO.relativePathToMedia}"
				var="mediaImage">
				<img src="<c:url value="${mediaImage}" context="/art/servimg"/>"
					class="w3-image w3-hover-opacity" style="max-width: 250px;" />
			</c:forEach>
		</div>
